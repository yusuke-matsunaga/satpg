...
///
/// Copyright (C) 2005-2011, 2013-2014, 2017 Yusuke Matsunaga
/// All rights reserved.
...
public:
  ...
  FaultAnalyzer(const TpgNetwork& network,
		TvMgr& tvmgr);
...
public:
  ...
  void
  init(vector<const TpgFault*>& fault_list);
